...
export function renderOrderSummary() {
    ...
    cart.forEach((item) => {
        ...
        cartSummaryHTML += `
        <div class="cart-item-container js-container-checkout-${matchingProduct.id}">
            ...
            <div class="cart-item-details-grid">
                ...
                <div class="product-quantity">
                    <span>
                    Quantity: <span class="quantity-label-${matchingProduct.id}">${item.quantity}</span>
                    </span>
                    <span class="update-quantity-link link-primary" data-product-id="${matchingProduct.id}">
                    Update
                    </span>
                    <input type="number" class="input-quantity input-${matchingProduct.id}">
                    <span class="save-inputed-quantity link-primary" data-product-id="${matchingProduct.id}">Save</span>
    ...
    clearOrder.forEach((order) => {
        order.addEventListener("click", () => {
            ...
            const checkOutContainer = document.querySelector(`.js-container-checkout-${productId}`);
    ...
    document.querySelectorAll(".update-quantity-link").forEach((update) => {
        update.addEventListener("click", () => {
            ...
            const updateQuantity = document.querySelector(`.js-container-checkout-${productId}`);
    ...
    document.querySelectorAll(".save-inputed-quantity").forEach((save) => {
        save.addEventListener("click", () => {
            ...
            const saveUpdate = document.querySelector(`.js-container-checkout-${productId}`);
    ...
    function deliveryOptionsHTML(matchingProduct, item) {
        ...
        deliveryOptions.forEach((deliveryOption) => {
            ...
            const priceString = deliveryOption.priceInCents === 0 ? 'FREE': `$${formatCurrency(deliveryOption.priceInCents)} -`;
